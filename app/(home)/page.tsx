...
export default async function Home() {
  // chamar prisma para obter barbearia
  ...
  return (
    <div>
      ...
      <div className="px-5 mt-6">
        <h2 className="font-xs mb-3 uppercase text-gray-400 font-bold">
          Agendamentos
        </h2>
        <BookingItem />
      </div>
      ...
      <div className="mt-6">
        <h2 className="px-5 font-xs mb-3 uppercase text-gray-400 font-bold">
          Recomendados
        </h2>
